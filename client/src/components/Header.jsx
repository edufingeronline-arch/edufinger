    ...
    <header className="border-b border-[#5780dd] bg-[#5780dd]">
      <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between px-4 text-white md:h-16">
        ...
        <nav className="hidden flex-nowrap items-center gap-6 text-sm md:flex">
          ...
          <NavLink to="/udaan" onClick={close} className={({ isActive }) => isActive ? 'text-white' : 'text-white/90 hover:text-white'}>Udaan</NavLink>
          <NavLink to="/khazana" onClick={close} className={({ isActive }) => isActive ? 'text-white' : 'text-white/90 hover:text-white'}>Khazana</NavLink>
        ...
        <nav className="md:hidden">
          <div className="mx-auto max-w-7xl px-4 pb-3 pt-2 text-white">
            <ul className="space-y-2">
              ...
              <li><NavLink to="https://kasoti.pages.dev" onClick={close} className={({ isActive }) => isActive ? 'block rounded px-2 py-2 bg-white/10' : 'block rounded px-2 py-2 hover:bg-white/10'}>Kasoti</NavLink></li>
              <li><NavLink to="/udaan" onClick={close} className={({ isActive }) => isActive ? 'block rounded px-2 py-2 bg-white/10' : 'block rounded px-2 py-2 hover:bg-white/10'}>Udaan</NavLink></li>
              <li><NavLink to="/khazana" onClick={close} className={({ isActive }) => isActive ? 'block rounded px-2 py-2 bg-white/10' : 'block rounded px-2 py-2 hover:bg-white/10'}>Khazana</NavLink></li>
